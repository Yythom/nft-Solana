...
export const debou = debounce((fn) => {
    fn()
}, 600)
export const isOrca = (tokenName) => {
    return !!(tokenName.toLocaleUpperCase().indexOf('ORCA') !== -1)
}
export const isRaydium = (tokenName) => {
    return !!(tokenName.toLocaleUpperCase().indexOf('RAYDIUM') !== -1)
}
